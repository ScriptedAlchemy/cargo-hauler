...
import { cargoJsonDemuxFlag } from '../../cargo/argv.js';

import { hasLibKind } from '../../cargo/execution/cargo-json.js';
import type { TailBuffer } from '../../cargo/execution/executor.js';
import type { NormalizedCargoIntent } from '../../cargo/intent.js';
import { terminalStatuses } from '../../contracts/protocol.js';
import type {
  AdmissionHold,
  AttachMode,
  EstimateSource,
...
import type { TicketLogWriter } from '../../storage/ticket-log.js';
...
export interface SubmitInput {
  ...
  /** Tickets that must settle first (`--after`); see dependencies.ts. */
...
export interface Job {
   ...
   * only in synchronous frames (dependencies.ts).
   */
