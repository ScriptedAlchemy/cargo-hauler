...
import { sharedTargetGroups, sharedTargetRefusal, sharedTargetWarning } from '../src/lib/shared-target.js';
...
// collapsed upstream (tests/intent-normalizer.test.ts) and by the live
// daemon cases in tests/daemon-broker.test.ts.
