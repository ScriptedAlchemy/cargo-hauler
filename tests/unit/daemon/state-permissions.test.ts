...
import { spawnDetachedDaemon } from '../../../src/internal/client/ensure-daemon.js';
import { resolveDaemonConfig } from '../../../src/internal/daemon/config.js';
import { openLedgerDatabase } from '../../../src/internal/storage/ledger.js';
import { bindDaemonSocket } from '../../../src/internal/daemon/main.js';
import { acquireSingletonLockWith } from '../../../src/internal/daemon/runtime/singleton.js';
import {
  readSocketIdentity,
  removeStaleSocketEntry,
} from '../../../src/internal/daemon/runtime/socket-ownership.js';
import { openTicketLog, ticketLogDirFor } from '../../../src/internal/storage/ticket-log.js';
import { appendHookRecord } from '../../../src/internal/host-hooks/record.js';
import { writeCursor } from '../../../src/internal/host-hooks/hook-state.js';
import {
